    ...
    return (
        <section className="mx-auto max-w-screen-xl">
            <div className="p-8 h-screen">
                ...
                <div className="flex items-start justify-start pt-56 md:pt-0 md:items-end mt-16 md:mt-24 w-full h-full md:h-3/6 px-auto bg-[url('/images/banner_m.jpg')] md:bg-[url('/images/banner.png')] bg-cover bg-center bg-no-repeat mx-auto rounded-3xl">
                    <div className="px-8">
