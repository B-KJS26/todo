        ...
        <img src="/images/JANDA.png" alt="JANDA" className="mx-auto w-full transform transition-transform ease-in-out" />
                ...
                <div className="md:w-6/12 h-full pt-32 pb-36 px-12 md:block hidden">
                    <div className="border-solid border-black border-t-2 ">
                            <p className="lg:text-3xl pt-12 px-2 text-2xl">진료시간 및 오시는 길 안내</p>
                            <p className="mt-12 mb-4 px-2 lg:text-2xl text-gray-400 text-xl">오시는 길</p>
                            ...
                            <div className="px-2">
                                <p className="flex items-center justify-start">
                                    <span className="pr-2.5 xl:text-2xl font-normal tracking-wider text-xl">월 ~ 금</span>
                                    <span className="font-medium tracking-wide xl:text-2xl text-xl ">09:00 ~ 18:00</span>
                                </p>
